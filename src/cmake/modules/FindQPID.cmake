...
if(MSVC)
   ...
   find_library(QMFCONSOLE_LIBRARY qmfconsole)
   ...
   if(QMFCONSOLE_LIBRARY)
       set(QMFCONSOLE_FOUND true)
   endif(QMFCONSOLE_LIBRARY)
   ...
   if(QMFCONSOLE_FOUND)
		if(NOT QPID_FIND_QUIETLY)
			   message(STATUS "Found QMFCONSOLE: ${QMFCONSOLE_LIBRARY}")
	    endif(NOT QPID_FIND_QUIETLY)
   else(QMFCONSOLE_FOUND)
    	if(QPID_FIND_REQUIRED)
			message(FATAL_ERROR "Could not find QMFCONSOLE")
		endif(QPID_FIND_REQUIRED)
   endif(QMFCONSOLE_FOUND)
